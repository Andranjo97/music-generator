...
def test__should_be_instance_of_base_audio_processor_adapter():
...
def test__should_return_url_from_generated_progression(mock_segment_empty, mock_segment_from_wav):
